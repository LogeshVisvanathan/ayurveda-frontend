...
import { QrCode, MapPin, FileCheck, Download, Shield, Search, ArrowRight } from 'lucide-react';
        ...
        <div className="max-w-[100rem] mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="font-paragraph text-base md:text-lg text-secondary/80 max-w-4xl">
              Browse verified and authenticated Ayurvedic products with complete traceability information.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Link to={`/consumer-detail/${product.id}`} key={product.id} className="group">
                <motion.div
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-secondary/70">
                        ...
                        <span className="font-paragraph text-sm">{product.location}</span>
                      </div>
                    </div>
                    <motion.div
                  ...
                  <div className="flex-1">
                    <p className="font-paragraph text-xs text-secondary/70 uppercase mb-2">Verification Status</p>
                    <div className="mb-4">
                      <span className={`inline-block px-3 py-1 font-heading text-xs uppercase ${
                        product.status === 'Verified & Approved' 
                  ...
                  <div className="border-t border-secondary/20 pt-4 space-y-2">
                    <div className="flex justify-between">
                      <span className="font-paragraph text-xs text-secondary/70">Farmer</span>
                      <span className="font-heading text-sm text-secondary">{product.farmer}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-paragraph text-xs text-secondary/70">Batch ID</span>
                      <span className="font-heading text-sm text-secondary">{product.batchId}</span>
                    </div>
                  </div>
                </motion.div>
              </Link>
