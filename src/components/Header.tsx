      ...
      <div className="max-w-[120rem] mx-auto px-8 md:px-16 py-6">
        <div className="flex items-center justify-between">
          ...
          <Link to="/">
            ...
            >
              <h1 className="font-heading text-3xl md:text-4xl text-secondary uppercase leading-none">
                AYURVEDIC
              </h1>
              <p className="font-paragraph text-xs text-secondary/70 uppercase tracking-wider mt-1">
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.nav
              ...
              className="lg:hidden mt-6 pt-6 border-t border-secondary/20 overflow-hidden"
            >
                ...
                {navLinks.map((link, index) => (
                  ...
                  >
                    <Link
                      ...
                      className={`block py-2 font-heading text-base uppercase tracking-wide transition-colors ${
                        isActive(link.path)
                          ? 'text-primary'
                          : 'text-secondary/70 hover:text-primary'
                      }`}
